...
import (
	...
	"github.com/lierbai/nspider/core/common/page_items"
...
func (this *Page) AddTargetRequest(url string, respType string) *Page {
	this.targetRequests = append(this.targetRequests, request.NewRequest("GET", url, nil, nil, "", respType, "", nil, nil))
	return this
}
...
func (this *Page) AddTargetRequestWithHeaderFile(url string, respType string, headerFile string) *Page {
	...
	this.targetRequests = append(this.targetRequests, r.setHeaderbyFile(headerFile, true))
	return this
}
